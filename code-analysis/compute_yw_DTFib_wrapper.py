...
def main():
    parser = argparse.ArgumentParser(
        description="Wrapper for compute_yw_DTFib.py across short×long lag combinations"
    )
    parser.add_argument(
        "-f", "--file",
        type=str,
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.003,
        help="Tolerance passed to compute_yw_DTFib.py for Fibonacci matching (default 0.003)"
    )
